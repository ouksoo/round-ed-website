	...
	var app = Sammy(function(){
		...
		this.get('#work', function(){
			...
			$('.work-list li').on('click', function(){
				...
				var clickNth = $(this).data('nth');

				console.log(clickNth);

				$('.work-list li').each(function(){

					if(nowWork == clickNth){   //$('.work-list li:nth-child('+clickNth+')')

					}
					else {
						TweenMax.to($(this), 1, {height:'170',ease:Expo.easeOut});
					}
				});
